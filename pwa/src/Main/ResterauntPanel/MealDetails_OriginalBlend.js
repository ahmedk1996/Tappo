          ...
          <h2 style={{ color: '#dc0f2d' , paddingTop: "30px",paddingBottom:"30px"}}> <strong> Tim Hortons </strong> </h2>
            ...
            <div className="row">
                ...
                <div className="menu-item" data-toggle="modal" data-target="#exampleModal" >
                 <img src="/Images/originalBlend.png" alt="example_image"  width='70px' align='center' style={{marginBottom:"0.2em",marginLeft:"2.5em"}} />
                    <h3  className="card-title" style={{fontSize:"1em",marginLeft:"0.5em", marginTop:"1em"}} >Original Blend Coffee</h3>
