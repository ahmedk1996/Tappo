          ...
          <h2 style={{ color: '#dc0f2d' , paddingTop: "30px",paddingBottom:"30px"}}> <strong> Tappo Side Restaurant</strong> </h2>
            ...
            <div className="row">
                ...
                <div className="menu-item" data-toggle="modal" data-target="#exampleModal" >
                 <img src="/Images/coffee.png" alt="example_image"  width='70px' align='center' style={{marginBottom:"0.2em",marginLeft:"2.8em"}} />
                    <h3  className="card-title" style={{fontSize:"1em",marginLeft:"3.3em", marginTop:"1em"}} >Coffee</h3>
                   
                    <h4  className="price" style={{fontSize:"1em",marginLeft:"3.5em", marginTop:"2em"}} >FREE</h4>
                </div>
                <div>
