...
export default class MealDetails_BostonCream extends React.Component {
    ...
    closeModal() {
      ...
      renderProduct = ({menu_id, item_name,tableN,personName})=> <div key={menu_id}>Item Ordered: {item_name},  table Number: {tableN}, personName: {personName}</div>
    ...
    render() {
        ...
        return (
          ...
          <div >
          <Link to='/MenuTappo'> <img src="/Images/back.png" alt="example33k "width='40px' align='center' style={{paddingTop:"34.5px",paddingLeft:"10px"}}/></Link>
          </div>

          <div className="col" >
          <h2 style={{ color: '#dc0f2d' , paddingTop: "30px",paddingBottom:"30px"}}> <strong> Tappo Side Restaurant</strong> </h2>
          </div>
            ...
            <div className="row">
                ...
                <div className="menu-item" data-toggle="modal" data-target="#exampleModal" >
                 <img src="/Images/orange.png" alt="example_image"  width='70px' align='center' style={{marginBottom:"0.2em",marginLeft:"2.5em"}} />
                    <h3  className="card-title" style={{fontSize:"1em",marginLeft:"1em", marginTop:"1em"}} >Orange Juice</h3>
                   
                    <h4  className="price" style={{fontSize:"1em",marginLeft:"3em", marginTop:"1.5em"}} >FREE</h4>
                </div>
                <div>
