          ...
          <h2 style={{ color: '#dc0f2d' , paddingTop: "30px",paddingBottom:"30px"}}> <strong> Tappo Side Restaurant</strong> </h2>
            ...
            <div className="row">
                ...
                <div className="menu-item" data-toggle="modal" data-target="#exampleModal" >
                 <img src="/Images/apple.png" alt="example_image"  width='40px' align='center' style={{marginBottom:"0.2em",marginLeft:"3.9em"}} />
                    <h3  className="card-title" style={{fontSize:"1em",marginLeft:"2.7em", marginTop:"1em"}} >Apple Juice</h3>
                   
                    <h4  className="price" style={{fontSize:"1em",marginLeft:"4em", marginTop:"1.5em"}} >FREE</h4>
                </div>
                <div>
