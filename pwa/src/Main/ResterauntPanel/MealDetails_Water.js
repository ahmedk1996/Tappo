          ...
          <h2 style={{ color: '#dc0f2d' , paddingTop: "30px",paddingBottom:"30px"}}> <strong> Tappo Side Restaurant</strong> </h2>
            ...
            <div className="row">
                ...
                <div className="menu-item" data-toggle="modal" data-target="#exampleModal" >
                 <img src="/Images/water.png" alt="example_image"  width='50px' align='center' style={{marginBottom:"0.2em",marginLeft:"3.7em"}} />
                    <h3  className="card-title" style={{fontSize:"1em",marginLeft:"4em", marginTop:"1em"}} >Water</h3>
